...
const typeDefs = gql`
  ...
  type Kubernetes implements DeploymentTargetInterface {
    id: Int
  ...
  type Environment {
    ...
    """
    The DeploymentTarget this environment is deployed into
    """
    deploymentTarget: DeploymentTargetInterface
    """
    Identifier of this environment in the deployment target
    """
  ...
  type Query {
    ...
    """
    Returns Environment Object by a given deploymentTargetId
    """
    environmentByDeploymentTargetId(
      deploymentTargetId: String!
    ): Environment
    ...
    """
    Returns all Deployment Targets
    """
    allDeploymentTargets: [DeploymentTargetInterface]
    """
